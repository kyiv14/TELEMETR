...
MAX_PAGES = 3             # Сколько страниц парсить в каждой категории (по 20 каналов на стр.)
...
def start_parsing():
            ...
            try:
                ...
                if response.status_code == 200:
                    ...
                    for ch in channels:
                        ...
                        # Поиск юзернейма админа в описании био
                    ...
                    time.sleep(1) # Интервал безопасности
                else:
    ...
    if leads:
        ...
        print("\n❌ База пуста. Проверьте лимиты тарифа или ключи.")
